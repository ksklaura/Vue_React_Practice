...
import Vue34exParent from '../components/vue34ex/Vue34exParent.vue'; // template 안의 <Vue34exParent></Vue34exParent> 때문에 만든 것!
...
export default {
  ...
  data() {
    ...
    return {
      mesg: null, // template 안의 {{mesg}} 때문에 만든 것
    };
  },
  //template: ``,
  methods: {},
  components: {
    Vue34exParent: Vue34exParent, // template 안의 <Vue34exParent></Vue34exParent> 때문에 만든 것!
  },
  computed: {
